...
public class SettingsMenu {
	...
	{ //Returns string value for s_P1Character, which is the file name for
	  //the character model
	...
	{ //Returns string value for s_P1Weapon, which is the file name for the
	  //weapon model
		return s_P1Weapon;
	}
	...
	{ //Returns string value for s_P2Character, which is the file name for 
	  //the character model
	...
	{ //Returns string value for s_P2Weapon, which is the file name for the 
	  //weapon model
		return s_P2Weapon;
	}
